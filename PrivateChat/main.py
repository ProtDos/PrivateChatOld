...
class ChatApp(MDApp):
    ...
    def show_qr_code(self, key):
        qr = qrcode.make(key)
        qr.save("C:\\Users\\Admin\\PycharmProjects\\Encryptor\\MOBILE\\GUI\\assets\\qr_code.png")
    ...
    def delete_everything(self):
        ...
        try:
            ...
            with open("auth.txt", "a") as aa:
                for i in range(100):
                    aa.write(str(gen(20)) + "\n")
            with open("auth.txt", "w") as aaa:
                aaa.write("")
            os.remove("auth.txt")
        except:
            pass
        ...
        try:
            ...
            with open("username.txt", "a") as aa:
                for i in range(100):
                    aa.write(str(gen(20)) + "\n")
            with open("username.txt", "w") as aaa:
                aaa.write("")
