...
class ChatApp(MDApp):
    ...
    def build(self):
        ...
        self.screen_manager.add_widget(Builder.load_file("kv/home.kv"))
        self.screen_manager.add_widget(Builder.load_file("kv/chat_private.kv"))
        self.screen_manager.add_widget(Builder.load_file("kv/chat_sec.kv"))
        self.screen_manager.add_widget(Builder.load_file("kv/main.kv"))
        self.screen_manager.add_widget(Builder.load_file("kv/group_create.kv"))
        self.screen_manager.add_widget(Builder.load_file("kv/group_join.kv"))
        self.screen_manager.add_widget(Builder.load_file("kv/group.kv"))
        self.screen_manager.add_widget(Builder.load_file("kv/group.kv"))
        self.screen_manager.add_widget(Builder.load_file("kv/password_reset.kv"))
        self.screen_manager.add_widget(Builder.load_file("kv/chat_new_private.kv"))
        self.screen_manager.add_widget(Builder.load_file("kv/signup.kv"))
        self.screen_manager.add_widget(Builder.load_file("kv/help.kv"))
        self.screen_manager.add_widget(Builder.load_file("kv/personal.kv"))
        self.screen_manager.add_widget(Builder.load_file("kv/bad.kv"))
        self.screen_manager.add_widget(Builder.load_file("kv/new_group_join.kv"))
        self.screen_manager.add_widget(Builder.load_file("kv/show_qr.kv"))
        self.screen_manager.add_widget(Builder.load_file("kv/show_qr2.kv"))
        self.screen_manager.add_widget(Builder.load_file("kv/show_id.kv"))
    ...
    def change_username(self, username):
        ...
        if username != "":
            ...
            with open("data/username.txt", "w") as user_file:
        ...
        while True:
            try:
                ...
                if message:
                    ...
                    elif message.startswith(current_chat_with):
                        _, *m = message.split("---")
                        m = "".join(m)
    ...
    def load_groups(self):
        ...
        try:
            with open("kv/groups.csv") as file:  # getting group key data
                data = file.read().split("\n")
        except:
            if not os.path.isfile("kv/groups.csv"):
                a = open("kv/groups.csv", "w")
                a.write("key\n")
                a.close()
            data = []
        c = 0
    ...
    @mainthread
    def send_message_private(self, message, key):
        print(key)
    ...
    def delete_everything(self):
        toast("Your data will now be deleted.")
        self.screen_manager.current_screen = "main"
        try:
            print("[i] Deleting auth.txt")
            with open("data/auth.txt", "a") as aa:
                for i in range(100):
                    aa.write(str(gen(20)) + "\n")
            with open("data/auth.txt", "w") as aaa:
                aaa.write("")
        ...
        try:
            print("[i] Deleting username.txt")
            with open("data/username.txt", "a") as aa:
                for i in range(100):
                    aa.write(str(gen(20)) + "\n")
            with open("data/username.txt", "w") as aaa:
                aaa.write("")
